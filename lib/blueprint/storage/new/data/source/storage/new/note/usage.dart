...
_button01(BuildContext context) async {
  File? _ = await NewStorageHelper.to.getSync("hello.text");
  log(_?.path);
  log(await _?.length());
...
_button06(BuildContext context) async {
  //google drive set
  // await NewStorageHelper.googleDrive.setString("hihi ff");
}

_button07(BuildContext context) async {
  //google drive get
  // String? _ = await NewStorageHelper.googleDrive.getString();
  // log(_);
}

...
_button02(BuildContext context) async {
  ...
  int _id = (id != null) ? id : Random().nextInt(10000);
...
_button03(BuildContext context) async {
  ...
  late NotificationCalendar schedule;
  ...
  await AwesomeNotifications().createNotification(
      content: NotificationContent(
        id: _id,
        channelKey: channelKey ?? 'scheduled',
        title: title,
        body: body,
        notificationLayout: notificationLayout ?? NotificationLayout.BigText,
        payload: payload,
...
_button04(BuildContext context) async {
  ...
  await AwesomeNotifications().createNotification(
      ...
      schedule: NotificationCalendar.fromDate(
          date: DateTime.fromMicrosecondsSinceEpoch(showTimeMicros),
          allowWhileIdle: true));
}

_button05(BuildContext context) async {
  // cancel all schedules channel notification
  String channelKey = 'basic';
